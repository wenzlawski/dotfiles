...
;; NOTE: This will be taken over by embark.
...
(defcustom org-ref-citation-alternate-insert-actions
  '(("p" consult-bibtex-open-pdf "Open PDF file (if present)")
    ("u" consult-bibtex-open-url-or-doi "Open URL or DOI in browser")
    ;; this insert-citation only inserts an org-ref cite.
    ("c" consult-bibtex-insert-citation "Insert citation")
    ("R" consult-bibtex-insert-reference "Insert formatted reference")
    ("k" consult-bibtex-insert-key "Insert BibTeX key")
    ("b" consult-bibtex-insert-bibtex "Insert BibTeX entry")
    ("a" consult-bibtex-add-PDF-attachment "Attach PDF to email")
    ("e" consult-bibtex-edit-notes "Edit notes")
...
;; (defun org-ref-consult-bibtex-display-transformer (candidate)
...
(defun org-ref-cite-insert-consult ()
  ...
  (let* ((bibtex-completion-bibliography (org-ref-find-bibliography))
    ...
    (cdr (consult--read candidates
			:default t
			:require-match t
			:sort nil))))

;; NOTE: This is the part of ivy-read that is not directty supported by consult.
;; Here we will have to use embark to get the actions
...
(provide 'org-ref-consult)

;;; org-ref-consult.el ends here
